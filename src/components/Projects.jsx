    ...
    return (
        <>
            <p className="text-light w-75 fs-5 mx-auto">
                My name is Dalal, I live in Damascus Syria, I am 24 years old, These are some of my projects
            </p>
        </>
    )
}
        ...
        <>
            <section id="projects">
                <div className="projects-section">
                    ...
                    <p className='sup-paragraph w-75 mb-5'>My name is Dalal, I live in Damascus Syria, These are some of my projects.</p>
